...
class ViewProduto(Toplevel):
    ...
    def ControllerAdicionar(self, nome, consignado, distribuidor):
        ModelProduto.adiciona(self, nome, consignado, distribuidor)
        self.ControllerListar()
    ...
    def ControllerAlterar(self, produto, novo_nome, novo_consignado, novo_distribuidor):
        nome = produto.split(',')[0]
        ModelProduto.altera(self, nome, novo_nome, novo_consignado, novo_distribuidor)
        self.ControllerListar()
...
class ModelProduto:
    def adiciona(self, nome, consignado, distribuidor):
        
        str_consignado = 'Sim' if consignado == 1 else 'Não'

        arq = open('produtos.txt', 'a')
        arq.write(nome + ',' + str_consignado + ',' + distribuidor + '\n')
        arq.close()
    ...
    def altera(self, nome, novo_nome, novo_consignado, novo_distribuidor):

        str_consignado = 'Sim' if novo_consignado == 1 else 'Não'

        print(novo_nome + ',' + str_consignado + ',' + novo_distribuidor + '\n')
        ...
        for line in lines:
            if (line.split(',')[0] != nome):
                ...
                arq.write(novo_nome + ',' + str_consignado + ',' + novo_distribuidor + '\n')
        arq.close()
